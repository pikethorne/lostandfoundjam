...
class BossItemDecideyTime : MonoBehaviour
{
	...
	public void Awake()
	{
		if (currentLevel == 0)
		{
			GameObject item1 = itemPoolHead[UnityEngine.Random.Range(0, itemPoolBody.Count - 1)];
			itemPoolBody.Remove(item1);
			GameObject item2 = itemPoolHead[UnityEngine.Random.Range(0, itemPoolBody.Count - 1)];
		...
		{
			GameObject item1 = itemPoolGun[UnityEngine.Random.Range(0, itemPoolBody.Count - 1)];
			itemPoolBody.Remove(item1);
			GameObject item2 = itemPoolGun[UnityEngine.Random.Range(0, itemPoolBody.Count - 1)];
			itemPoolBody.Remove(item2);
			leftChoiceSelection = Instantiate(item1);
			leftChoiceSelection.transform.parent = leftChoice.transform;
			leftChoiceSelection.transform.localPosition = new Vector3();
		...
		{
			GameObject item1 = itemPoolArm[UnityEngine.Random.Range(0, itemPoolBody.Count - 1)];
			itemPoolBody.Remove(item1);
			GameObject item2 = itemPoolArm[UnityEngine.Random.Range(0, itemPoolBody.Count - 1)];
			itemPoolBody.Remove(item2);
			leftChoiceSelection = Instantiate(item1);
			leftChoiceSelection.transform.parent = leftChoice.transform;
			leftChoiceSelection.transform.localPosition = new Vector3();
